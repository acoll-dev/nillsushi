<div class="view-header">{{'MODULE.CATEGORY.TITLE.LIST' | grTranslate}}</div>
<div class="view-content">
    <table gr-table remote="{module: 'category', action: 'get', onelevel: true}" export-csv="GRIFFO_categoryList">
        <tr gr-repeat="(key, data) in $data">
            ...
            <td data-title="'LABEL.NAME' | grTranslate" sortable="'name'" filter="{'name': 'text'}" header-class="col-2" class="col-2">
                {{data.name}}
            </td>
            ...
            <td data-title="'LABEL.MODULE' | grTranslate" sortable="'namemodule'" filter="{'namemodule': 'text'}" header-class="col-2" class="col-2">
                {{'MODULE.' + data.namemodule.toUpperCase() + '.NAME' | grTranslate}}
            </td>
            ...
            <td data-title="'BUTTON.EDIT' | grTranslate" header-class="col-1" class="col-1 text-center">
                <button class="btn btn-xs btn-table btn-primary" ng-click="grTable.fn.edit(grTable,data.idcategory,'view/admin/edit.php')"><i class="fa fa-fw fa-edit"></i></button>
            </td>
            <td data-title="'BUTTON.DELETE' | grTranslate" header-class="col-1" class="col-1 text-center">
                <button class="btn btn-xs btn-table btn-danger" ng-click="grTable.fn.delete(grTable,data.idcategory)"><i class="fa fa-fw fa-times"></i></button>
            </td>
        </tr>
    </table>
</div>
