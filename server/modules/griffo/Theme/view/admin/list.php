<div class="view-header">{{'MODULE.THEME.TITLE.LIST' | grTranslate}}</div>
<div class="view-content">
    <table gr-table remote="{module: 'theme', action: 'get', onelevel: true}" export-csv="GRIFFO_themeList">
        <tr gr-repeat="(key, data) in $data">
            <td data-title="'#'" sortable="'idtheme'" filter="{'idtheme': 'text'}" header-class="col-1" class="col-1 text-center">
                {{data.idtheme}}
            </td>
            ...
            <td data-title="'BUTTON.EDIT' | grTranslate" header-class="col-1" class="col-1 text-center">
                <button class="btn btn-xs btn-table btn-primary" ng-click="grTable.fn.edit(grTable,data.idtheme,'view/admin/edit.php')"><i class="fa fa-fw fa-edit"></i></button>
            </td>
            <td data-title="'BUTTON.DELETE' | grTranslate" header-class="col-1" class="col-1 text-center">
                <button class="btn btn-xs btn-table btn-danger" ng-click="grTable.fn.delete(grTable,data.idtheme)"><i class="fa fa-fw fa-times"></i></button>
            </td>
        </tr>
    </table>
</div>
