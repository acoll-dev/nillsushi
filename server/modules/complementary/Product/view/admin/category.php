<div class="view-header">{{'MODULE.PRODUCT.TITLE.CATEGORY' | grTranslate}}</div>
<div class="view-content">
	<div class="view-content-inner" ng-controller="formCtrl">
		<div class="container-fluid">
			<h4>{{'MODULE.PRODUCT.TITLE.CATEGORY.NEW' | grTranslate}}</h4>
            <div class="well">
	...
	<div ng-controller="tableCtrl">
        <table gr-table list="categoriesList" reload="updateCategories(true)" export-csv="GRIFFO_categoryProductList">
