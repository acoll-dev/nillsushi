...
<div class="view-content" ng-controller="tableCtrl">
    ...
    <div class="col-xs-6">
        <button type="bytton" class="btn btn-default btn-lg" ng-click="legend_visible = !legend_visible" ng-class="{'active': legend_visible}" title="Mostrar/Ocultar legenda">
            <i class="fa fa-fw fa-bookmark"></i>
        </button>
    </div>
    <div class="col-xs-6 text-right" style="padding: 7px;">
        <button type="button" class="btn btn-primary btn-lg" ng-click="calendar_mode = !calendar_mode" ng-attr-title="{{calendar_mode ? 'Mostrar lista' : 'Mostrar calendário'}}">
            <i class="fa fa-fw" ng-class="{'fa-calendar': !calendar_mode, 'fa-list': calendar_mode}"></i>
        </button>
    </div>
    <div class="text-center col-xs-12 well" style="padding: 7px" ng-show="legend_visible">
        <div class="pull-left">
    ...
    <div class="well" style="background: #FFFFFF;" ng-show="calendar_mode">
        <div ui-calendar="calendar.config" ng-model="calendar.orders"></div>
    </div>
    <table gr-table list="orders" reload="reload()" sortby="{'idorder': 'desc'}" export-csv="GRIFFO_orderList" ng-show="!calendar_mode">
