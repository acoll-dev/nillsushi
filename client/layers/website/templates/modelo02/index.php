    ...
    <nav class="navbar">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-left">
                <li data-ng-class="{'active': menu.active, 'dropdown': menu.child.length > 0, 'open': menu.open}" data-gr-dropdown data-ng-repeat="menu in GRIFFO.menu" ng-if="$index < 3">
            ...
            <div class="navbar-header" gr-autoscale="'1:1'">
