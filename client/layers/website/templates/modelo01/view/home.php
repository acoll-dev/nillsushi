...
<div class="block" data-ng-if="GRIFFO.config.page.home.highlight && GRIFFO.config.page.home.highlight.length > 2 && GRIFFO.config.page.home.highlight.length % 2 !== 0"></div>
